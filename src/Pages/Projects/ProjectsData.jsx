export const projectData = [
    {
        ...
        title: 'SOCIAL RING',
        background: 'Social Ring lets you create custom rings for your profile pictures on Clubhouse, Instagram, or your favorite social media platform.',
        objectives: 'Automate profile pictures border design with a variety of custom-made borders. Allowing image upload and resizing by pinching the screen in or out.',
        subHeading: 'Socail Ring needed an IOS app and landing page to help spread the word and allow users to adjust their social media avi\'s online. My task was to design the branding, implement business functionality, and a responsive landing page that incorporated key virtual business features of avatar customization. \nResearch, UX, UI, Development',
    ...
    },
    {
        ...
        title: 'KIDVERCITY',
        background: 'The Kidvercity website is an online platform dedicated to providing a safe and educational environment for kids to learn and have fun.',
        objectives: 'Kidvercity offers a wide range of educational resources, including interactive lessons, quizzes, and activities, designed to engage and stimulate young minds.',
        ...
        prototype: 'https://www.figma.com/proto/png9L2ZcXbkZQL32Ylf8wv/KidverCity-Design-File?type=design&node-id=65-62753&t=aTYi50BsBlRaavG7-0&scaling=min-zoom&page-id=0%3A1',
