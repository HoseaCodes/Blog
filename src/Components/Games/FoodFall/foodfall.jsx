...
import plate from '../../../Assets/SVG/baby-animal-shaped-plate-svgrepo-com.svg'
import burger from '../../../Assets/SVG/burger-svgrepo-com.svg'
import burrito from '../../../Assets/SVG/burrito-svgrepo-com.svg'
import donut from '../../../Assets/SVG/donut-svgrepo-com.svg'
import pizza from '../../../Assets/SVG/pizza-svgrepo-com.svg'

import fire from '../../../Assets/SVG/campfire-svgrepo-com.svg'

import tick from '../../../Assets/SVG/checked-tick-svgrepo-com.svg'
import cross from '../../../Assets/SVG/cancel-svgrepo-com.svg'

import winSound from '../../../Assets/Sounds/445974__breviceps__cartoon-slurp.wav'
import loseSound from '../../../Assets/Sounds/burn.wav'
...
function FoodFall() {
    ...
    useEffect(() => {
        if (foodY3 === 75 && (spawnPosition3 * size.width)/100 - x > -200 && (spawnPosition3 * size.width)/100 - x < 50) {
            let f = 1
            let i = 0
            const scaleInt = setInterval(() => {
                setFoodScale3(f -= 0.1)
    ...
    return (
        ...
        <div className='foodWrapper' onMouseMove={() => handleMove()} onClick={() => startGame()} >
           ...
           <img src={food3} alt='food' className='food2' style={{left: `${spawnPosition3}vw`, top: `${foodY3}vh`, transform: `scale(${foodScale3}, ${foodScale3})` }} />
