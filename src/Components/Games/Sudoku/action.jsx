...
export const Action = (props) => {
  return (
    <div className={  props.action === 'undo'
                      ? "sudoku-status__action-undo"
                      : props.action === 'erase'
                      ? "sudoku-status__action-erase"
                      : props.action === 'hint'
                      ? "sudoku-status__action-hint"
                      : ""
                    } onClick={props.onClickAction} >
      <Svg action={props.action} />
      <p className="sudoku-status__action-text">
        {
          props.action === 'undo'
            ? 'Undo'
            : props.action === 'erase'
