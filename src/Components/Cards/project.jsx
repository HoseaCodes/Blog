            ...
            >
              ...
              <div className="case-study-mask-number">
                {props.project.id < 10 ? (
                  ...
                  <CardCover>{props.project.id}</CardCover>
                )}

                <CardCover>
                  <CardOverlay data-index={`0${props.project.id}`}>
                    {props.project.id}
                  </CardOverlay>
                </CardCover>
              </div>
              <CardTextWrapper>
                ...
                <CardBtn>
                  ...
                  <CardIcon>
                    ...
                    >
                      <CardSVGPath d="M405.606 167.5l-21.212 21.213 34.393 34.393H0v30h418.787L384.394 287.5l21.212 21.213 70.607-70.607"></CardSVGPath>
                    </CardSVG>
                  </CardIcon>
                </CardBtn>
              </CardTextWrapper>
