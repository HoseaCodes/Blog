                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="description">
                                ...
                                <a href="https://apps.apple.com/us/app/social-ring/id1551446005" target="_blank" className="button highlight"><i className="fa fa-apple fa-lg"></i>Get The App</a>
                            </div>
                        </div>
                        <div className="col-md-5 col-md-offset-1 hidden-xs">
                            <img src="https://i.imgur.com/i8bkYCv.png" />
                        </div>
                    </div>
                </div>
            </div>
