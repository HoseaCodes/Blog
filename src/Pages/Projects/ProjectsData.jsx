...
1.) https://www.writermind.io/ 
	- (NFT - Full stack w/AI)
	- Helps users with minimum AI experience use AI to it’s full potential
...
export const projectData = [
  {
    ...
    features: {
      ...
      highlights: [
        "＞ Create profile pictures with a variety of custom-made borders with over 100 borders to choose from.",
        "＞ Add your image and resize by pinching the screen in or out.Change your border from our list of categories.",
        // "＞ 'Join a Team' Initiative: Fullstack Implementation of Team Events, Leaderboard Logic, Individual vs.Team Progress",
        // "＞ Shopping Cart Logic",
        // "＞ Page: Frontend Implementation, Page Optimization with Lighthouse",
      ...
      otherContributions: [
        "🖊️ Premade Borders",
        "🖊️ Create profile pictures with a variety of custom-made borders.",
        "🖊️  Choose from over 50 borders.",
        // "🖊️  Emoji Encryption and Decryption",
        // "🖊️  Refactoring Pages to Utilize NextJS Data Fetching",
      ],
    },
    background:
  ...
  },
  {
    ...
    features: {
      ...
      highlights: [
        "＞ Event Creation Flow: Backend Architecture, Validation Logic, Data Persistence.",
        "＞ 'Join a Team' Initiative: Fullstack Implementation of Team Events, Leaderboard Logic, Individual vs.Team Progress",
        "＞ Shopping Cart Logic",
        "＞ Email Newsletter Subscriptions",
      ],
      ...
      otherContributions: [
        "🖊️  Home and Event Page Optimizations: Virtualization, Programmatic Image Compression via Backend, Lazy Loading Components",
        "🖊️  Emoji Encryption and Decryption",
        "🖊️  Refactoring Pages to Utilize NextJS Data Fetching",
      ],
    },
