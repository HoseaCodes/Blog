...
class ReactSecurity extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        const { name, date, info, title, img, tags, lists, lists2, subHeading } = this.state.article;
        return (
            <div>
                <NavBar2 />
                    ...
                    <article className='blog-main'>
                        ...
                        <div className='blog-combo'>
                            <article>
                                ...
                                <img className='blog-img' src="https://i.imgur.com/19i5Whc.png" alt={name} />
