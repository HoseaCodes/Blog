        ...
        <div className="row">
            <div className="col-lg-4 col-xl-4">
                <div className="card-box text-center">
                    <img src={user.avatar} className="rounded-circle avatar-xl img-thumbnail" alt="profile-image"/>

                    <h4 className="mb-0">{user.name.charAt(0).toUpperCase() + user.name.slice(1).toLowerCase()}</h4>
                    ...
                    <div className="text-left mt-3">
                        ...
                        <p className="text-muted mb-2 font-13"><strong>Full Name :</strong> <span className="ml-2">{user.name.charAt(0).toUpperCase() + user.name.slice(1).toLowerCase()}</span></p>

                        <p className="text-muted mb-2 font-13"><strong>Mobile :</strong>
                            <span className="ml-2">
                                {user.phone}
                                (123) 123 1234
                            </span>
                        ...
                        <p className="text-muted mb-2 font-13"><strong>Email :</strong> <span className="ml-2 ">{user.email}</span></p>
                        <p className="text-muted mb-2 font-13"><strong>Occupation :</strong> <span className="ml-2 ">{user.email}</span></p>
                        <p className="text-muted mb-1 font-13"><strong>Location :</strong> <span className="ml-2">USA {user.location}</span></p>
                        <ul class="profile-info-list">
                            <p className="text-muted mb-1 font-13"><strong>FRIEND LIST (9) :</strong> </p>
                            <li class="img-list">
                ...
                <div className="card-box">
                    ...
                    {user.skills.map(skill => {
                        ...
                        <div className="mt-2  pt-1">
                            <h6 className="text-uppercase">{skill} Test <span className="float-right">90%</span></h6>
            ...
            <div className="col-lg-8 col-xl-8">
                <div className="card-box">
                    <ul className="nav nav-pills navtab-bg">
                        ...
                        <li className="nav-item">
                            <a href="#settings" data-toggle="tab" aria-expanded="false" className="nav-link ml-0 active">
                    ...
                    <div className="tab-content">
                        ...
                        <div className="tab-pane" id="settings">
                            <form>
                                <h5 className="mb-3 text-uppercase bg-light p-2"><i className="mdi mdi-account-circle mr-1"></i> Personal Info</h5>
                                ...
                                <h5 className="mb-3 text-uppercase bg-light p-2"><i className="mdi mdi-earth mr-1"></i> Social</h5>
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            ...
                                            <div className="input-group">
                                                <div className="input-group-prepend">
                                                    <span className="input-group-text"><i className="fab fa-facebook-square"></i></span>
                                                </div>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            ...
                                            <div className="input-group">
                                                <div className="input-group-prepend">
                                                    <span className="input-group-text"><i className="fab fa-skype"></i></span>
                                                </div>
                                ...
                                <h5 className="mb-3 text-uppercase bg-light p-2"><i className="mdi mdi-office-building mr-1"></i> Work & Education</h5>
                                 <div className="row">
