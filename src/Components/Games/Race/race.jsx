...
import snail from "../../SVG/snail-svgrepo-com.svg";
import leaf from "../../SVG/leaf-svgrepo-com.svg";
import mouseIcon from "../../SVG/mouse-svgrepo-com.svg";
...
export default function Race() {
  const crunch =
    "https://d2nrcsymqn25pk.cloudfront.net/Assets/Sounds/429591__inspectorj__chewing-breadstick-single-d.wav";
  ...
  return (
    <div onMouseMove={() => handleDrag()} className="raceWrapper">
      {showMouse && (
        <p className="instructionText">guide snail to food with mouse</p>
      )}
      <img
        alt="snail"
        draggable="false"
      ...
      <img
        ...
        style={{ left: `${finishPositionX}vw`, top: `${finishPositionY}vh` }}
        alt="finish"
        className="finish"
        src={leaf}
      />
