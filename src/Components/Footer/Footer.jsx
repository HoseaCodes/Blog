...
const Footer = (props) => {
    const { defaultFooter, setDefault } = props;
            ...
            <div className="container bottom_border">
              <div className="row">
                <div className=" col-sm-4 col-md col-12 col">
                  ...
                  <p className="mb10">
                    HoseaCodes’ mission statement is to build the future while
                    empowering every person and every organization on the planet
                    to achieve more.{" "}
                  </p>
                  <p>
                    <i className="fa fa-location-arrow"></i> Houston, TX{" "}
                  </p>
                  <p>
                    <i className="fa fa-phone"></i> +1-281-780-8424
                  </p>
                  <p>
                ...
                <div className=" col-sm-4 col-md  col-6 col">
                  ...
                  <ul className="footer_ul_amrc">
                    ...
                    <li>
                      <a href="/client">Client Details</a>
                    </li>
                    <li>
                      <a href="/project">Project Details</a>
                    </li>
                    <li>
                      <a href="/shop">Hoseacodes Shop</a>
                    </li>
                    <li>
                ...
                <div className=" col-sm-4 col-md col-12 col twitter-footer">
                  ...
                  <ul className="footer_ul2_amrc">
                    <li>
                      ...
                      <p>
                        Day 56 #100DaysOfCode I added a markdown preview...
                        <a href="https://twitter.com/DominiqueRHosea/status/1382724497954930693">
                          twitter.com/status/Day56
                        </a>
                      </p>
                    </li>
                    <li>
                      ...
                      <p>
                        Day 55 #100DaysOfCode I revisted solidity smart ...
                        <a href="https://twitter.com/DominiqueRHosea/status/1382215669115080705">
                          twitter.com/status/Day55
                        </a>
                      </p>
                    </li>
                    <li>
                      ...
                      <p>
                        Received my work laptop. I’m so excited!...
                        <a href="https://twitter.com/DominiqueRHosea/status/1381995531375890437">
                          twitter.com/status/startjob
                        </a>
                      </p>
                    </li>
                  </ul>
