              ...
              <div className={styles.gameInfo}>
                  ...
                  >
                    <AnimatedText>
                      ...
                      >
                        <a
                          href={
                            currentGame ? currentGame.link : templateGame.link
                          }
                          target="_blank"
                        >
                          {currentGame ? currentGame.name : "No"} Website
                        </a>
                        <h4>
                          Released:{" "}
                          {currentGame
                        ...
                        <h4>
                          Main Genre:{" "}
                          {currentGame ? currentGame.genre : templateGame.genre}
                        </h4>
                        <h4>
                          Developers:{" "}
                          {currentGame
                ...
                <div className={styles.addToCart}>
                  <div className={styles.infos}>
                    <h3>
                      ${currentGame ? currentGame.price : templateGame.price}
                    </h3>
                    <button
                      id={currentGame ? currentGame.id : templateGame.id}
                      onClick={handleLike}
                      aria-label="Like"
                    >
                      <Like
